  ...
  <div>
    <div class="viewports">
      <div :style="getQuatStyle(false, false)">
        <threerender class="prespectiv-view" v-if="shouldRender" :objects="objectManifest" :perspective='75'></threerender>
      </div>
      <div :style="getQuatStyle(true, true)">
        <!-- <wireframe :objects="objectManifest" :axis="AxisTypes.X" v-if="shouldRender"></wireframe> -->
        <threerender class="x-view" v-if="shouldRender" :objects="objectManifest" :perspective='0' :axis="AxisTypes.X"></threerender>
      </div>
      <div :style="getQuatStyle(false, true)">
        <!-- <wireframe :objects="objectManifest" :axis="AxisTypes.Y" v-if="shouldRender"></wireframe> -->
        <threerender class="y-view" v-if="shouldRender" :objects="objectManifest" :perspective='0' :axis="AxisTypes.Y"></threerender>
      </div>
      <div :style="getQuatStyle(true, false)">
        <!-- <wireframe :objects="objectManifest" :axis="AxisTypes.Z" v-if="shouldRender"></wireframe> -->
        <threerender class="z-view" v-if="shouldRender" :objects="objectManifest" :perspective='0' :axis="AxisTypes.Z"></threerender>
      </div>
    </div>
